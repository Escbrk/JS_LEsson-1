...
var t={addPost:document.querySelector(".js-add"),posts:document.querySelector(".js-posts"),formWrapper:document.querySelector(".js-form"),ERROR:document.querySelector(".js-error")};function e(e){e.preventDefault();
//!____________________________________________ ---> вариант 1
var n=e.currentTarget.elements,o=n.title,r=n.body;
//!____________________________________________
//!____________________________________________ ---> вариант 2
//!____________________________________________
//!____________________________________________
(function(t){var e={method:"POST",headers:{"Content-type":"application/json"},body:JSON.stringify(t)};return fetch("https://jsonplaceholder.typicode.com/posts",e).then((function(t){if(!t.ok)throw new Error(t.status);return t.json()}))})({title:o.value,body:r.value}).then((function(e){t.posts.insertAdjacentHTML("beforeend",function(t){var e=t.id,n=t.title,o=t.body;return"\n    <li data-id=\"'".concat(e,'">\n        <h2>').concat(n,"</h2>\n        <p>").concat(o,"</p>\n    </li>")}(e))})).catch((function(){t.ERROR.innerHTML="Невозможно добавить пост"})).finally((function(){t.formWrapper.innerHTML="",setTimeout((function(){t.ERROR.innerHTML=""}),2e3)}))}t.addPost.addEventListener("click",(function(){t.formWrapper.innerHTML='\n    <form action="submit" class=\'js-form-add\' style="display: flex; flex-direction: column">\n        <input type="text" name="title">\n        <textarea name="body" cols="30" rows="10"></textarea>\n        <button>Add post</button>\n    </form>\n    ',document.querySelector(".js-form-add").addEventListener("submit",e)}))}();
//# sourceMappingURL=index.3fdd1ff5.js.map
